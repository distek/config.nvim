...
Themes["lush"] = function()
	...
	local light_red = hsl(125, 93, 68).lighten(lightenAmount)
	local orange = hsl(279, 93, 68).lighten(lightenAmount)
	local yellow_orange = hsl("#D7BA7D").lighten(lightenAmount)
	...
	local theme = lush(function(injected_functions)
		...
		return {
			...
			FloatBorder({ fg = float_border_fg, bg = black }),
			...
			NormalFloat({ fg = norm_fg, bg = black }),
			-- NormalNC { },
